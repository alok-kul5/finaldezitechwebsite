...
- **White**: `#F6F6F6`
- **Grey Light**: `#EDEDED`
- **Theme Colors**: `dez-bg: #07070a`, `dez-surface: #0f1724`, `dez-primary: #0B3D91`, `dez-accent: #26c6da`, `dez-muted: #94a3b8`
...
- **Condensed**: Barlow Condensed / Space Grotesk (via `.font-condensed` class)
